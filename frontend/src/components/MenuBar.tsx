...
import { 
  Database, Settings, Plus, Save, Zap, Cpu, HelpCircle, Terminal, Sparkles, Edit2, X, Trash2, RefreshCw, Clock, Coffee, Book, Layout
} from 'lucide-react';
interface MenuItem {
    label?: string;
    ...
    const menus: Record<string, MenuItem[]> = useMemo(() => {
        ...
        return {
            ...
            View: [
                ...
                { label: 'Focus Mode', icon: <Layout size={14}/>, shortcut: 'F12', onClick: () => onAction?.('toggle_focus') },
            ...
            Tools: [
                ...
                { label: 'Run Script...', icon: <Terminal size={14}/>, onClick: () => onAction?.('run_script'), disabled: !hasConnections },
                { divider: true },
